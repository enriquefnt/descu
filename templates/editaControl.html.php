...
<form class="w3-container w3-light-grey" autocomplete="off" method="post" action=""?>
  ...
  <input type="hidden"name="id" id="idcontrol" value="<?=$datosControl['idcontrol'] ?? ''?>"><br><br>
...
<textarea id="Observaciones" name="Observaciones" rows="3" cols="40"><?=$datosControl['Observaciones'] ?? ''?></textarea>
